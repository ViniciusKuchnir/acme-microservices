...
public class UserBootstrapper implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if(userRepo.findByUsername("admin1@mail.com").isEmpty()) {
            User_SQL admin1 = new User_SQL("admin1@mail.com", encoder.encode("AdminPW1"),
        ...
        if(userRepo.findByUsername("admin2@mail.com").isEmpty()) {
            User_SQL mod1 = new User_SQL("admin2@mail.com", encoder.encode("AdminPW2"),
                    "Antonio Jose", "321984553", "Rua dois");
            mod1.addAuthority(new Role(Role.Mod));
            userRepo.save(mod1);
        }
        if(userRepo.findByUsername("user1@mail.com").isEmpty()) {
            User_SQL user1 = new User_SQL("user1@mail.com", encoder.encode("userPW1"),
        ...
        if(userRepo.findByUsername("user2@mail.com").isEmpty()) {
            User_SQL user2 = new User_SQL("user2@mail.com", encoder.encode("userPW2"),
        ...
        if(userRepo.findByUsername("user3@mail.com").isEmpty()) {
            User_SQL user3 = new User_SQL("user3@mail.com", encoder.encode("userPW3"),
        ...
        if(userRepo.findByUsername("user4@mail.com").isEmpty()) {
            User_SQL user4 = new User_SQL("user4@mail.com", encoder.encode("userPW4"),
        ...
        if(userRepo.findByUsername("user5@mail.com").isEmpty()) {
            User_SQL user5 = new User_SQL("user5@mail.com", encoder.encode("userPW5"),
        ...
        if(userRepo.findByUsername("user6@mail.com").isEmpty()) {
            User_SQL user6 = new User_SQL("user6@mail.com", encoder.encode("userPW6"),
        ...
        if(userRepo.findByUsername("user7@mail.com").isEmpty()) {
            User_SQL user7 = new User_SQL("user7@mail.com", encoder.encode("userPW7"),
        ...
        if(userRepo.findByUsername("user8@mail.com").isEmpty()) {
            User_SQL user8 = new User_SQL("user8@mail.com", encoder.encode("userPW8"),
        ...
        if(userRepo.findByUsername("user9@mail.com").isEmpty()) {
            User_SQL user9 = new User_SQL("user9@mail.com", encoder.encode("userPW9"),
        ...
        if(userRepo.findByUsername("user10@mail.com").isEmpty()) {
            User_SQL user10 = new User_SQL("user10@mail.com", encoder.encode("userPW10"),
        ...
        if(userRepo.findByUsername("user11@mail.com").isEmpty()) {
            User_SQL user11 = new User_SQL("user11@mail.com", encoder.encode("userPW11"),
